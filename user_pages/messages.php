...
.write_message .card_container
{
    margin-top:-10px;
}
.write_message .card_container .card_body .comments_user_info
{
    margin-top:-15px;
}
...
if(isset($_GET['id']))
{
    ...
    ?>
    <form action="../functions/create_message.php?id=<?= $id ?>" method="post">
...
?>
    ...
    (sender_id='$user_id' && receiver_id='$id') || (sender_id='$id' && receiver_id='$user_id') ORDER BY created_at DESC";
