...
<div class="center">
    ...
    <div class="content">
            ...
            <p>what's on you mind, &nbsp;<span><?= $last_name ?>?</span></p>
        </div>
...
<div class="left">
<a style="text-decoration:none;" href="user_profiles.php?id=<?= $row['user_id']; ?>">
<div><img src="../profile_images/<?= $row['user_profile']; ?>"></div>
<div class="auth">
<h4><?= $row['user_last_name']; ?> &nbsp; <?= $row['user_first_name'] ?>
</h4></a>
...
{
    echo "<span style='margin-top:1em;color:red;'>no post found<span>";
}
?>
...
<div class="card">
    ...
    <div class="card_body">
        ...
        <div class="content">
            <h4>What's on you mind, <?= $last_name; ?>?</h4>
            <form action="../functions/create_post.php" method="post" 
            enctype = "multipart/form-data">
                <div class="img_upload">
                    <p>image?</p>
                    <input type="file" name="file">
                </div>
            <textarea name="description" cols="30" rows="8" required placeholder="description">
            </textarea>
            <center>
