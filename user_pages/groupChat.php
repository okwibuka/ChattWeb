...
if(isset($_GET['id']))
{
    ...
    ?>
    <form action="../functions/groupChat_code.php?id=<?= $id ?>" method="post">
...
?>
    ...
    $query = "SELECT * FROM groupChat ORDER BY created_at DESC";
...
<div class="card_body">
    ...
    <img src="../profile_images/<?= $row['user_profile'] ?>" class="message_sender_img">
    <p><?= $row['user_last_name']; ?>&nbsp;<?= $row['user_first_name']; ?></p>
    </div>
...
<?php
    ...
    {
        echo"<span style='margin-left:7em;color:red;'>no chat found</span>";
    }
    ?>
