...
.messages_container .auth img
{
    width:30px;
    height:30px;
    border-radius:50%;
}
.messages_container .auth
{
    display:flex;
    margin-bottom:10px;
    width:100%;
...
.messages_container .auth a
{
    text-decoration:none;
    color:white;
}
.messages_container .auth .context
{
    
    margin:-13px 0 0 10px;
}
.messages_container .auth .context p
{
    font-weight:bolder;
}
.messages_container .auth .context .message
{
    color:grey;
    margin-top:-12px;
...
<div class="center">
    ...
    <div class="messages_container">
        ...
        $query = "SELECT * FROM messages WHERE (receiver_id='$id') ORDER BY created_at DESC";
    ...
    <div>
    <img src="../profile_images/<?= $row['sender_profile'] ?>" class="message_sender_img">
    </div>
    <a href="messages.php?id=<?php if($row['sender_id'] != $user_id)
    {
echo $row['sender_id'];
    } 
    else
    ...
    ?>">
    <div class="context">
    <p><?= $row['sender_last_name']; ?>&nbsp;<?= $row['sender_first_name']; ?></p>
    <div class="message">
    <small><?= $row['message']; ?></small>
        ...
        {
            echo "<span style='margin-left:7em;color:red;'>no message found</span>";
        }
    }
        ?>
