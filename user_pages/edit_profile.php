...
.container .box_two .bottom form label
{
    font-size:17px;
    line-height:3;
    color:indigo;
}
.container .box_two .bottom form input
{
    padding:5px;
    background:lightgrey;
    border-radius:5px;
...
.container .box_two .bottom form img
{
    width:50px;
    height:50px;
}
.container .box_two .bottom form button
{
    background:blue;
    border-radius:11px;
    padding:8px;
...
.container .box_two .bottom span a
{
    color:white;
    text-decoration:none;
}
    ...
    if($sql > 0)
    {
        ...
        while($row = mysqli_fetch_assoc($query_run))
        {
            ...
            <div class="names">
                ...
                <div class="top">
                <ul>
                    <li><a href="profile.php?id=<?=$user_id ?>">Over View</a></li>
                    <li><a href="" style="color:blue;">Edit Profile</a></li>
                ...
                <div class="bottom">
                    ...
                    <div>
                    <img src="../profile_images/<?= $row['image'] ?>" name="file">
                    <span>
                        <a href="">
                    ...
                    <form action="" method="post">
                        <button name="delete_profile" style="background:red;">
